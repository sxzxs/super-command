OpenAhkHelpFile(Keyword := "") {
    Static Zone := True
    Local n, Pos, Prefix, HTMLPage, Match, Match1, ZoneId
    ...
    If (Keyword == "" || StrLen(Keyword) > 50) {
        Run hh mk:@MSITStore:%g_AhkHelpFile%::/docs/AutoHotkey.htm
        Return
    }
    ...
    Run hh mk:@MSITStore:%g_AhkHelpFile%::%HTMLPage%
}
